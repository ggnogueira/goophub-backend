...
public class FileConverter {
    ...
    public String convertOWLtoGoopAtomic(String file, String actorName, String goalId, String url) {
    ...
    public String convertOWLtoGoopComplex(String file, String actorName, String goalId, String decompositionType, String atomicGoals, String url) {
